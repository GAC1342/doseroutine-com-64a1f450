    ...
    exercises: [
      ...
      },
      {
        ...
        cues: [
          ...
          "Hug the arms together, don't press",
          "Slow on the stretch",
        ],
      },
      {
        ...
        secondary: ["frontDelts"],
        cues: [
          "Lean the torso forward for chest",
      ...
      },
      {
        ...
        note: "Deeper stretch than the bar",
        pose: "benchLying",
        primary: ["chest"],
        secondary: ["frontDelts", "triceps"],
        cues: ["Wrists stacked over elbows", "Lower to chest level", "Press up and slightly in"],
      },
      {
        name: "Machine chest press",
        note: "Easy to push safely alone",
        pose: "machineSeated",
        primary: ["chest"],
        secondary: ["triceps", "frontDelts"],
        cues: ["Set the handles at mid-chest", "Shoulder blades back", "Control the return"],
      },
      {
        name: "Decline push-up",
        note: "Hits the upper chest at home",
        pose: "pushupFloor",
        primary: ["chest"],
        secondary: ["frontDelts", "triceps"],
        cues: ["Feet on a bench or step", "Body in one line", "Elbows about 45 degrees"],
      },
      {
        name: "Dumbbell floor press",
        note: "Shoulder-friendly pressing",
        pose: "floorLying",
        primary: ["chest", "triceps"],
        secondary: ["frontDelts"],
        cues: ["Upper arms touch the floor lightly", "Pause, then press", "Keep ribs down"],
      },
    ],
  },
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        secondary: ["biceps", "upperBack", "rearDelts", "forearms"],
        cues: [
          "Slight lean back, chest tall",
          "Bar to the collarbone",
          "Let the shoulders stretch up at the top",
        ],
      },
      {
      ...
      },
      {
        ...
        cues: [
          "Bar over mid-foot, back flat",
          "Push the floor away",
          "Lock out with the glutes, not the spine",
        ],
      },
      {
        name: "Chest-supported row",
        note: "Rows without loading the low back",
        pose: "machineSeated",
        primary: ["upperBack", "lats"],
        secondary: ["biceps", "rearDelts"],
        cues: ["Chest stays on the pad", "Pull elbows past the ribs", "Squeeze for a beat"],
      },
      {
        name: "Single-arm dumbbell row",
        note: "Fixes side-to-side gaps",
        pose: "seatedRow",
      ...
      {
        name: "T-bar row",
        note: "Thickness through the mid back",
        pose: "standingHinge",
        primary: ["upperBack", "lats"],
        secondary: ["biceps", "lowerBack"],
        cues: [
          "Hinge to about 45 degrees",
          "Pull to the belly button",
          "Do not jerk with the hips",
        ],
      },
      {
        name: "Straight-arm pulldown",
        note: "Lats without the arms tiring first",
        pose: "cableStand",
        primary: ["lats"],
        secondary: ["triceps", "abs"],
        cues: [
          "Soft elbows, locked angle",
          "Sweep the bar to the thighs",
          "Feel the lats, not the arms",
        ],
      },
      {
        name: "Rack pull",
        note: "Heavy top-half pulling",
        pose: "standingHinge",
        primary: ["lowerBack", "upperBack"],
        secondary: ["glutes", "hamstrings", "forearms"],
        cues: ["Bar set just below the knee", "Chest tall, lats tight", "Stand, do not lean back"],
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        cues: [
          ...
          "Press straight up past the forehead",
      ...
      },
      {
        ...
        note: "Comfortable overhead pressing",
        pose: "machineSeated",
        primary: ["frontDelts"],
        secondary: ["triceps", "traps"],
        cues: ["Elbows slightly in front", "Press without shrugging", "Lower to ear height"],
      },
      {
        name: "Arnold press",
        note: "Front and side delts in one",
        pose: "machineSeated",
        primary: ["frontDelts", "sideDelts"],
        secondary: ["triceps"],
        cues: ["Start palms facing you", "Rotate as you press", "Slow on the way down"],
      },
      {
        name: "Cable lateral raise",
        note: "Constant tension on side delts",
        pose: "cableStand",
        primary: ["sideDelts"],
        secondary: ["traps"],
        cues: ["Lead with the elbow", "Stop at shoulder height", "No swinging"],
      },
      {
        name: "Rear delt fly",
        note: "Balances all the pressing",
        pose: "machineSeated",
        primary: ["rearDelts"],
        secondary: ["upperBack", "traps"],
        cues: ["Hinge or use the pad", "Wide arc, soft elbows", "Squeeze the shoulder blades"],
      },
      {
        name: "Upright row",
        note: "Delts and traps together",
        pose: "standingPress",
        primary: ["sideDelts", "traps"],
        secondary: ["biceps"],
        cues: ["Wide-ish grip", "Pull to lower chest, not chin", "Stop if shoulders pinch"],
      },
      {
        name: "Barbell shrug",
        note: "Direct trap work",
        pose: "standingPress",
        primary: ["traps"],
        secondary: ["forearms"],
        cues: ["Straight up, not rolling", "Pause at the top", "Let the bar hang fully"],
      },
    ],
  },
  {
    ...
    exercises: [
      ...
      {
        name: "Hammer curl",
        note: "Biceps plus forearm thickness",
        pose: "standingCurl",
        primary: ["biceps", "forearms"],
        cues: ["Palms face each other", "Elbows pinned to the ribs", "No hip swing"],
      },
      {
        name: "Incline dumbbell curl",
        note: "Longest biceps stretch",
        pose: "inclineBench",
        primary: ["biceps"],
        secondary: ["forearms"],
        cues: [
          ...
          "Curl without lifting the elbow",
        ],
      },
      {
        name: "Preacher curl",
        note: "Strict, cheat-proof curling",
        pose: "machineSeated",
        primary: ["biceps"],
        secondary: ["forearms"],
        cues: ["Armpits into the pad", "Do not slam the elbows straight", "Control the lower half"],
      },
      {
        name: "Skull crusher",
        note: "Long-head triceps builder",
        pose: "benchLying",
        primary: ["triceps"],
        cues: [
          "Elbows point at the ceiling",
          "Lower to the forehead or behind",
          "Keep the upper arms still",
        ],
      },
      {
        name: "Overhead cable extension",
        note: "Stretches the triceps under load",
        pose: "cableStand",
        primary: ["triceps"],
        cues: ["Lean slightly forward", "Elbows stay narrow", "Full lockout each rep"],
      },
      {
        name: "Close-grip bench press",
        note: "Heavy triceps pressing",
        pose: "benchLying",
        primary: ["triceps", "chest"],
        secondary: ["frontDelts"],
        cues: ["Hands shoulder-width", "Elbows tucked", "Bar to lower chest"],
      },
      {
        name: "Reverse curl",
        note: "Forearms and grip",
        pose: "standingCurl",
        primary: ["forearms", "biceps"],
        cues: ["Palms down", "Light weight, strict form", "Squeeze at the top"],
      },
    ],
  },
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        cues: [
          "Lower until the knees hit 90°",
          "Keep the lower back on the pad",
          "Don't slam the lockout",
        ],
      },
      {
        name: "Lunge",
  ...
  },
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        cues: [
          "Lean forward slightly for glutes",
    ...
    exercises: [
      ...
      },
      {
        ...
        cues: [
          ...
          "Arms and legs long",
          "Lower them only as far as you can hold",
        ],
      },
      {
        name: "Side plank",
      ...
      },
      {
        ...
        secondary: ["abs"],
        cues: [
          "Lean back until you feel the core switch on",
      ...
      },
      {
        ...
        cues: [
          "Lift arms and legs a few inches only",
          "Lengthen, don't crunch the spine",
          "Look at the floor",
        ],
      },
      {
      ...
      },
      {
        ...
        cues: [
          ...
          "Only roll as far as you can hold the back flat",
        ],
      },
      {
        name: "Pallof press",
        ...
        cues: [
          ...
          "Press straight out and resist the twist",
          "Hold two seconds",
        ],
      },
    ],
  },
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        cues: [
          "Small hops, stay on the balls of the feet",
    ...
    exercises: [
      {
        ...
        cues: [
          ...
          "Hard effort, then full recovery",
