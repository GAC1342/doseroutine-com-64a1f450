...
export const Route = createFileRoute("/status")({
  ...
  head: () => ({
    meta: [
      { title: "DoseRoutine — System Status" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "DoseRoutine — System Status" },
      {
      ...
      { name: "twitter:title", content: "DoseRoutine — System Status" },
      {
    ...
    links: [{ rel: "canonical", href: "https://doseroutine.com/status" }],
    scripts: [
