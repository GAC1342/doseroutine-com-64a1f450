...
export const CANONICAL = "https://doseroutine.com/peptide-reconstitution-calculator";
  ...
  head: () => ({
    meta: [
      ...
      },
      {
        ...
        content:
          "DoseRoutine Peptide Reconstitution Calculator card — reconstitution math, BAC water volume and syringe units",
      },
        ...
        <section className="container max-w-4xl mx-auto px-4 py-12 md:py-20">
          <div className="text-center space-y-4 mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Enter vial size and BAC water volume to get exact mg/mL concentration, syringe units
              per dose, and doses remaining. Works with BPC-157, TB-500, semaglutide, tirzepatide,
          ...
          <div className="text-center space-y-4 py-8 border-t">
            ...
            <p className="text-muted-foreground">
              Reconstitution + dose logging + interaction checks + injection site rotation, all in
              one app.
            </p>
            <Button size="lg" asChild>
              <Link to="/install">
