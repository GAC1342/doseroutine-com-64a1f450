...
import { BarChart3, BookOpen, Gift, Shield, TrendingUp, Users } from "lucide-react";
...
const TOOLS = [
  ...
  },
  {
    ...
    icon: TrendingUp,
    desc: "Real visitors vs bot noise, sources, funnel and signup conversion.",
  },
  {
    to: "/admin/install-funnel",
    label: "Install → signup funnel",
    icon: TrendingUp,
